export default {
  ...
  DOCS_URL: 'https://cortexgen.cloud/docs/',
  HELP_CENTER_DOCS_URL: 'https://cortexgen.cloud/docs/help-center',
  TESTIMONIAL_URL: 'https://cortexgen.cloud/testimonial-content.json',
...
export const META_RESTRICTION_STATUS_URL = 'https://metastatus.com';
